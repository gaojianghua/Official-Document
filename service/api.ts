...
export const getAdminAdd = (params: any = {}, config = {}) => request.post('/api/root/add', params, config)
export const getAdminUpdate = (params: any = {}, config = {}) => request.post('/api/root/update', params, config)
export const getAdminDelete = (params: any = {}, config = {}) => request.post('/api/root/delete', params, config)
