...
export const loginEmail = (params: any, config = {}) => request.post('/api/user/login/email', params, config)
...
export const adminLoginEmail = (params: any = {}, config = {}) => request.post('/api/admin/login/email', params, config)
...
export const getAdminPermissionAdd = (params: any = {}, config = {}) => request.post('/api/permission/add', params, config)
export const getAdminPermissionUpdate = (params: any = {}, config = {}) => request.post('/api/permission/update', params, config)
export const getAdminPermissionDelete = (params: any = {}, config = {}) => request.post('/api/permission/delete', params, config)
export const getAdminRoleList = (params: any = {}, config = {}) => request.post('/api/role/list', params, config)
export const getAdminRoleAdd = (params: any = {}, config = {}) => request.post('/api/role/add', params, config)
export const getAdminRoleUpdate = (params: any = {}, config = {}) => request.post('/api/role/update', params, config)
export const getAdminRoleDelete = (params: any = {}, config = {}) => request.post('/api/role/delete', params, config)
export const getAdminList = (params: any = {}, config = {}) => request.post('/api/admin/list', params, config)
...
export const getEmailCode = (params: any = {}, config = {}) => request.post('/api/send_email_code', params, config)
